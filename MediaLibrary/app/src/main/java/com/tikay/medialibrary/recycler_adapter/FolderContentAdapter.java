...
public class FolderContentAdapter extends RecyclerView.Adapter<FolderContentAdapter.MyViewHolder>
{
  ...
  private Context context;
	private String TAG = FolderContentAdapter.class.getSimpleName();
	private int previousPosition = 0;

	public FolderContentAdapter(Context cntxt, ArrayList<FolderModel> songList) {
		context = cntxt;
		this.list = songList;
	...
	public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		View itemView = LayoutInflater.from(parent.getContext())
			.inflate(R.layout.folder_content_detail, parent, false);
