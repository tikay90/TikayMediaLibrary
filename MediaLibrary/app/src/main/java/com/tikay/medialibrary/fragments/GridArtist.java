...
import com.tikay.medialibrary.recycler_adapter.GridArtistAdapter;
...
public class GridArtist extends Fragment implements /*OnItemClickListener,*/OnQueryTextListener//,RecyclerView.OnItemTouchListener
{
	...
	private	GridArtistAdapter adapter;
	private String TAG = "GridArtists";
	...
	private void restoreState(Bundle savedInstanceState) {
		artistList = savedInstanceState.getParcelableArrayList(KEY);
		if(artistList != null) {
			adapter = new GridArtistAdapter(getActivity().getApplicationContext(), artistList);
	...
	private void initRecyclerView(ArrayList<ArtistModel> artistsList) {
		if(artistsList != null) {
			adapter = new GridArtistAdapter(getActivity(), artistList);
